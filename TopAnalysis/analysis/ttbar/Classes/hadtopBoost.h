...
// Tue Oct 27 10:57:04 2015 by ROOT version 6.02/05
// from TTree events/events
// found on file: flatTree_JetHT.root
//////////////////////////////////////////////////////////

#ifndef hadtopBoost_h
#define hadtopBoost_h
...
hadtopBoost::hadtopBoost(TTree *tree) : fChain(0)
{
   Init(tree);
}

hadtopBoost::~hadtopBoost()
{
   if (!fChain) return;
   //delete fChain->GetCurrentFile();
}

Int_t hadtopBoost::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hadtopBoost::LoadTree(Long64_t entry)
{
...
void hadtopBoost::Init(TTree *tree)
{
...
void hadtopBoost::Show(Long64_t entry)
{
...
Int_t hadtopBoost::Cut(Long64_t entry)
{
